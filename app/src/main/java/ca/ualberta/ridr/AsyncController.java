...
public class AsyncController {
    ...
    //Gets results that have the keyword somewhere in their properties
    /*public JsonArray getAllFromIndexKeyword(String dataClass, String keyword) {
        controller = new AsyncDatabaseController("keyword");
        try{
            String searchString =
        }
    }*/
